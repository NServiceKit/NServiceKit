...
namespace NServiceKit.ServiceHost.Tests.Formats
{
    ...
    public class TemplateTests
    {
        ...
        public void Can_Render_MarkdownPage_with_foreach()
        {
            ...
            var foreachLinks = "  - NServiceKit - http://www.NServiceKit.net\r\n"
...
## Haz 2 links
  ...
  - NServiceKit - http://www.NServiceKit.net
    - REST
    - JSON
    - XML
  - AjaxStack - http://www.ajaxstack.com
...
".NormalizeNewLines();
        ...
        {
            var template = @"@model NServiceKit.ServiceHost.Tests.Formats.TemplateTests+Person
# Generic View Page
...
<label for=""FirstName"">FirstName</label> <input id=""FirstName"" name=""FirstName"" type=""text"" value=""Demis"" />".NormalizeNewLines();
        ...
        {
            var template = @"@inherits NServiceKit.ServiceHost.Tests.Formats.TemplateTests+CustomMarkdownViewBase<NServiceKit.ServiceHost.Tests.Formats.TemplateTests+Person>
# Generic View Page
...
<p><img src=""path/to/img"" alt=""inline-img"" />
 <div id=""first-name""><div class=""inner inline-block"">Demis</div></div>".NormalizeNewLines();
        ...
        {
            var template = @"@helper Ext: NServiceKit.ServiceHost.Tests.Formats.TemplateTests+CustomMarkdownHelper
