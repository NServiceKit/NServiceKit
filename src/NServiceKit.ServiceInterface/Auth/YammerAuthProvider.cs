...
{
    /// <summary>
    /// The NServiceKit Yammer OAuth provider.
    /// </summary>
    /// <remarks>
    /// <para>
    /// This provider is loosely based on the existing NServiceKit's Facebook OAuth provider.
    /// </para>
    /// <para>
    ...
    /// <![CDATA[
    ///     <!-- NServiceKit Yammer OAuth config -->
