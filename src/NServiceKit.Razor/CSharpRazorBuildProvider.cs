...
{
    /// <summary>A sharp razor build provider.</summary>
    ...
    public class CSharpRazorBuildProvider : BuildProvider
    {
        ...
        /// <summary>Initializes a new instance of the NServiceKit.Razor.CSharpRazorBuildProvider class.</summary>
        ...
        ///
        /// <value>
        /// A read-only <see cref="T:System.Web.Compilation.CompilerType" /> representing the code generator, code compiler, and compiler settings used to build source code for the virtual path. The base
        /// class returns null.
        /// </value>
