...
<p>This is my custom footer for Home</p>
        ...
        {
            var pageTemplate =
@"@model NServiceKit.ServiceHost.Tests.Formats_Razor.Product
<fieldset>
...
".NormalizeNewLines();
        ...
        {
            var pageTemplate =
@"@model System.Collections.Generic.List<NServiceKit.ServiceHost.Tests.Formats_Razor.Product>
...
<tr><th>0</th><th>DVD</th><th>11.99</th></tr>
        ...
        {
            var pageTemplate =
@"@inherits NServiceKit.ServiceHost.Tests.Formats_Razor.CustomBaseClass<NServiceKit.ServiceHost.Tests.Formats_Razor.Product>
