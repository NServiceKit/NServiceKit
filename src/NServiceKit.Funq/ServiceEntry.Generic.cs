...
namespace NServiceKit.Funq
{
	internal sealed class ServiceEntry<TService, TFunc> : ServiceEntry, IRegistration<TService>
	{
        /// <summary>Initializes a new instance of the NServiceKit.Funq.ServiceEntry&lt;TService, TFunc&gt; class.</summary>
        ///
	    ...
	    internal class AquiredLock : IDisposable
	    {
            ...
            /// <summary>Initializes a new instance of the NServiceKit.Funq.ServiceEntry&lt;TService, TFunc&gt;.AquiredLock class.</summary>
            ///
