    ...
    public class SqlTiming
    {
        ...
        public SqlTiming(DbCommand command, ExecuteType type, Profiler profiler)
        {
            ...
            if (!Profiler.Settings.ExcludeStackTraceSnippetFromSqlTimings)
                StackTraceSnippet = NServiceKit.MiniProfiler.Helpers.StackTraceSnippet.Get();
        ...
        /// <summary>
        /// Called when database reader is closed, ending profiling for <see cref="NServiceKit.MiniProfiler.Data.ExecuteType.Reader"/> SqlTimings.
        /// </summary>
