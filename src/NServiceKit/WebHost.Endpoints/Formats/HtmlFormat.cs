...
namespace NServiceKit.WebHost.Endpoints.Formats
{
	public class HtmlFormat : IPlugin
	{
		...
		public static string HtmlTitleFormat
			= @"Snapshot of <i>{0}</i> generated by <a href=""http://www.NServiceKit.net"">NServiceKit</a> on <b>{1}</b>";
		...
		{
			AppHost = appHost;
			//Register this in NServiceKit with the custom formats
		...
		{
			// NServiceKit.WebHost.Endpoints.Formats.HtmlFormat.html
