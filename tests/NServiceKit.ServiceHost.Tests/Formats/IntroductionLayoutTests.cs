...
current date/year: 2014</p>
        ...
        {
            var pageTemplate =
@"@model NServiceKit.ServiceHost.Tests.Formats.Product
<fieldset>
...
@"<fieldset>
 ...
 <input id=""ProductID"" name=""ProductID"" type=""text"" value=""10"" />    </div>
        ...
        {
            var pageTemplate =
@"@model System.Collections.Generic.List<NServiceKit.ServiceHost.Tests.Formats.Product>
@helper Prod: NServiceKit.ServiceHost.Tests.Formats.ExternalProductHelper
...
<tr><th>0</th><th>DVD</th><th>11.99</th></tr>
        ...
        {
            var pageTemplate =
@"@inherits NServiceKit.ServiceHost.Tests.Formats.CustomBaseClass<NServiceKit.ServiceHost.Tests.Formats.Product>
