<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="NServiceKit.WebHost.IntegrationTests.Default" %>
<%@ Import Namespace="NServiceKit.Html" %>
<%@ Import Namespace="NServiceKit.Text" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <%=NServiceKit.MiniProfiler.Profiler.RenderIncludes(null, null, null, null, false, null).AsRaw() %>
  </head>
